...
type DropboxProps = React.PropsWithChildren<{
  ...
  inputElProps?: DropzoneInputProps & {
  ...
  return (
    <>
      <div
        {...getRootProps()}
        className={clsx(
          "m-3 rounded border border-dashed border-gray-500/25 bg-gray-50/50 px-2 py-8",
      ...
      >
        ...
        >
          <MdOutlineUploadFile
            className="p-5 rounded-full bg-gray-600 text-gray-200"
            size={70}
          />
